...
router.get('/:projectId/digests', (req: Request, res: Response) => projectsController.getProjectDigests(req, res));
router.post('/:projectId/digests/generate', (req: Request, res: Response) => projectsController.generateDailyDigest(req, res));
...
router.get('/:projectId/sprints/:sprintId/retrospective', (req: Request, res: Response) => projectsController.getSprintRetrospective(req, res));
router.post('/:projectId/sprints/:sprintId/retrospective/generate', (req: Request, res: Response) => projectsController.generateSprintRetrospective(req, res));
router.patch('/:projectId/sprints/:sprintId/retrospective/notes', (req: Request, res: Response) => projectsController.updateSprintRetrospectiveNotes(req, res));
